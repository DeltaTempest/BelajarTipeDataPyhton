...
#append adalah method untuk menambahkan elemen data baru ke bagian akhir list
list1.append("Budi") # menambahkan string baru ke list1
print(list1)

#extend method berfungsi untuk menambahkan list atau data struktur satu ke data struktur lainnya
